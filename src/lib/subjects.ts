...
export const subjectsByOrientation = {
  "Ciclo Basico": {
    1: [ "Matemática", "Ciencias Naturales", "Ciencias Sociales", "Prácticas del Lenguaje", "Inglés", "Construcción de Ciudadanía", "Educación Artística", "Educación Física" ],
    2: [ "Matemática", "Prácticas del Lenguaje", "Inglés", "Fisicoquímica", "Biología", "Construcción de Ciudadanía", "Educación Artística", "Geografía", "Historia" ],
    3: [ "Matemática", "Prácticas del Lenguaje", "Inglés", "Fisicoquímica", "Biología", "Construcción de Ciudadanía", "Educación Artística", "Geografía", "Historia" ],
    4: [], 5: [], 6: []
  },
  Economia: {
    1: [], 2: [], 3: [],
...
export const orientations: { key: string, label: string }[] = [
    ...
    { key: "Economia", label: "Economía y Administración" },
    { key: "Ciencias Naturales", label: "Ciencias Naturales, Salud y Ambiente" },
    { key: "Arte", label: "Arte" },
    { key: "Ciencias Sociales", label: "Ciencias Sociales y Humanidades" },
